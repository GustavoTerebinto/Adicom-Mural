    ...
    <div class="container">
        <div class="row">
            <div class="col-4 hero-img">
                <img src="{{ asset('img/undraw.co/admin_orders.png') }}" class="w-75 h-auto mx-auto" alt="">
            </div>
            <div class="col-8 d-flex flex-column justify-content-center">
                <h1>Minha Fila de Serviços</h1>
                <h2>Acompanhe os pedidos da sua fila de Administrador.</h2>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="px-5 py-14 mx-auto">
                        <div class="flex items-center lg:w-3/5 mx-auto pb-10 mb-10 sm:flex-row flex-col">
                            ...
                            <div class="flex-grow sm:text-left mt-6 sm:mt-0">
                                <h2 class="text-gray-900 text-lg title-font font-semibold mb-2">Você não tem pedidos na sua fila</h2>
                                <p class="leading-relaxed text-base">Dê uma olhada nos <a href="{{ route('admin.orders') }}">serviços solicitados</a></p>
                            </div>
                        </div>
                    </div>
                </section>
