    ...
    <div class="text-gray-600 body-font overflow-hidden mb-12">
        <div class="flex flex-wrap">
            <div class="w-full flex flex-col items-start">
                <span
                    class="inline py-1 px-2 rounded bg-indigo-50 text-indigo-500 text-xs font-medium tracking-widest">{{ @$order->service->category->name }}
                                    ...
                                    <tr class="row mw-100 py-2 t-row" style="">
                                        ...
                                        <td class="text-wrap col-12 col-xl-7">
                                            ...
                                            @elseif (@$field['data']['type'] == 'file')
                                                ...
                                                <a href="{{ asset(Storage::url($field['answer'])) }}"
                                                    class="underline" target="_blank">{{ $field['answer'] }}</a>
                                            @else
                                                {{ $field['answer'] }}
                                            @endif
                                        </td>
                ...
                <div class="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-100 mt-auto w-full">
                    <span class="text-gray-400 mr-3 inline-flex items-center leading-none text-sm pr-3 py-1">
                        ...
                        Criado em {{ $order->created_at_human }}
                    ...
                    <span
                        ...
                        Última atualização: {{ $order->updated_at->diffForHumans() }}
                    </span>
    ...
    @admin
        <div class="mb-4 w-full">
            ...
            <div class="form-control mb-4 pb-4">
                ...
                <input wire:model="github_issue_link" type="text" name="github_issue_link"
                    placeholder="Ex.: https://github.com/practice-uffs/programa/issue/234"
                    class="input input-bordered @error('github_issue_link') input-error @enderror" />
